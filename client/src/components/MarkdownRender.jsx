    ...
    <div className="markdown-container bg-gradient-to-b from-gray-50 to-white text-gray-800 min-h-screen dark:bg-gradient-to-b dark:from-gray-800 dark:to-black dark:text-gray-300">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <header className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-center text-white mb-4 dark:text-gray-100 bg-gradient-to-r from-blue-600 to-indigo-800 p-10 rounded">
            {title}
          </h1>
        ...
        <article className="prose prose-lg max-w-none dark:prose-invert">
          <ReactMarkdown
            ...
            components={{
              h1: ({ node, ...props }) => (
                <h1
                  className="text-3xl font-bold mt-8 mb-4 dark:text-gray-100"
                  {...props}
                />
              ),
              h2: ({ node, ...props }) => (
